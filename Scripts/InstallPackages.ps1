...
# Install Teams (System-wide)
# New-Item -Path 'HKLM:\SOFTWARE\Citrix\PortICA' -Force | Out-Null #NO LONGER INCLUDED IN DOCUMENTATION
...
# Install Teams WebRTC

Invoke-WebRequest -Uri 'https://query.prod.cms.rt.microsoft.com/cms/api/am/binary/RE4vkL6' -OutFile 'c:\temp\Teams-WebRTC.msi'
Invoke-Expression -Command 'msiexec /i C:\temp\Teams-WebRTC.msi /quiet /l*v C:\temp\teamswebrtcinstall.log'